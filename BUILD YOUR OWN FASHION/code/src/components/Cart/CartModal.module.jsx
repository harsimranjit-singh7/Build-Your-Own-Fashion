...
<div className={modalcss.credit_card_section}>
    ...
    <div className={modalcss.expiry_section}>
        <input type='text' placeholder='Expiry Month (MM)' maxLength='2' />
        <input type='text' placeholder='Expiry Year (YY)' maxLength='2' />
    </div>
</div>
...
<div className={modalcss.charges_section}>
    <p>Item Amount: ${orderDetails.unit_price * orderDetails.quantity}</p>
    <p>Shipping Charges: $10</p>
    <p>Total Amount: ${orderDetails.unit_price * orderDetails.quantity + 10}</p>
</div>
